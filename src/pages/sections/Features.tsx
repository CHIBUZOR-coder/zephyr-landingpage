...
export const Features = () => {
  return (
    <section className='py-20'>
      <Container>
        <div className='relative rounded-2xl border border-[#1a2a2a] bg-[#071313] px-3 lg:px-8 py-4 lg:py-8 sm:p-10 overflow-hidden'>
          {/* subtle glow */}
          ...
          <div className='relative z-10 max-w-[700px]'>
            <h2 className='text-white text-[35px] sm:text-2xl font-[700] leading-snug'>
